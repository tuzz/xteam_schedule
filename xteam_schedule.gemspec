Gem::Specification.new do |s|
  ...
  s.files       = ['README.md', 'lib/xteam_schedule.rb', 'lib/xteam_schedule/core.rb', 'lib/xteam_schedule/io.rb', 'lib/xteam_schedule/db.rb', 'lib/xteam_schedule/resource_group.rb', 'lib/xteam_schedule/resource.rb']
